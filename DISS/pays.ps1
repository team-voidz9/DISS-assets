...
Write-Host "1. Tegra Explorer BIN" -ForegroundColor green -BackgroundColor black
if ($preRelease) {
...
$filename1 = Split-Path -Path ($downloadUriBuilder11.Path) -Leaf       
...
$filename12 = Split-Path -Path ($downloadUriBuilder2.Path) -Leaf       
